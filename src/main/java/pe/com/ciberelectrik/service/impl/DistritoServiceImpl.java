...
public class DistritoServiceImpl implements DistritoService {
    ...
    @Override
    public DistritoEntity findById(Integer id) { return repositorio.findById(id).get(); }

    @Override
    public DistritoEntity add(DistritoEntity obj) { return repositorio.save(obj); }

    @Override
    public DistritoEntity update(DistritoEntity obj, Integer id) {
    ...
    @Override
    public DistritoEntity delete(Integer id) {
        DistritoEntity objdis = repositorio.findById(id).get();
    ...
    @Override
    public DistritoEntity enable(Integer id) {
        DistritoEntity objdis = repositorio.findById(id).get();
